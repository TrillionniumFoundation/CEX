# COMPATIBILITY SHIM
# Original script moved to scripts\\legacy\\audit-persistence-regression-check.ps1.
...
$legacyPath = Join-Path $PSScriptRoot 'legacy\\audit-persistence-regression-check.ps1'
& $legacyPath @args
exit $LASTEXITCODE

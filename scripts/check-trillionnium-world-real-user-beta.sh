...
PROVIDER_PROBE_MODEL="${CEX_REAL_USER_BETA_PROVIDER_PROBE_MODEL:-openai-codex/gpt-5.5}"
PROVIDER_PROBE_TRANSPORT="${CEX_REAL_USER_BETA_PROVIDER_PROBE_TRANSPORT:-gateway}"

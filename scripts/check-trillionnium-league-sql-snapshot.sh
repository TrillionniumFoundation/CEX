...
assert '0024_add_trillionnium_region_story_unlock_runtime_column.sql' in raw, 'repository migration floor missing'
...
assert migration_floor == '0024_add_trillionnium_region_story_unlock_runtime_column.sql', migration_floor

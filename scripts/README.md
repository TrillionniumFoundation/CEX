...
The default account gate is read-only. The mutating smoke requires password auth to be enabled and verifies register/session/logout, Argon2id registry storage, plaintext absence, and bad-login rate limiting.

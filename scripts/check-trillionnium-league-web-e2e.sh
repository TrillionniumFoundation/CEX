...
summary = {
    ...
    'has_world_map_optimization_contracts': all(token in world_html_after for token in ['world-map-readability-lod', 'world-map-performance-budget', 'world-map-transport-delta', 'world-map-shadow-renderer', 'trillionnium_world_map_readability_lod_v1', 'trillionnium_world_map_runtime_performance_budget_v1', 'trillionnium_world_map_transport_delta_v1', 'trillionnium_world_map_renderer_shadow_v1', 'data-parity-source="app-map-readability-lod"', 'data-parity-source="app-map-transport-delta"']),

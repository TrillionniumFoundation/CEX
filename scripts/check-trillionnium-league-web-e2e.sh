...
summary = {
    ...
    'has_client_app_map_readability_lod': all(token in app_html for token in ['trillionnium_world_map_readability_lod_v1', 'map_readability_lod_visible', 'app-map-readability-lod', 'data-visible-marker-budget="18"', 'One route first']),
    'has_client_app_route_runner_funnel_telemetry': all(token in app_html for token in ['app-route-runner-funnel-telemetry', 'trillionnium_route_runner_funnel_telemetry_v1', 'data-time-to-reward-target-seconds="1800"']),

...
for needle in ['Trillionnium League', 'Trillionnium World', 'Global-first Beta', '海外市场首发', 'Playable Now', '当前可玩版本', 'Web Battle Console', '网页战斗台', 'Guild Halls', '公会大厅', 'Battle Timeline', '战斗时间线', 'Submit Result', '提交战果', 'Progression System', '角色成长系统', '/skills', '/tools', '/skins']:
    assert needle in html, needle

world_status, world_html = get('/world')
assert world_status == 200, world_status
for needle in ['Trillionnium World', 'Global-first open world', '面向海外首发', 'World Action Console', '世界行动台', 'Reality Mirror Adventure', '现实镜像冒险', 'Global Real-world Map Engine', 'world-real-map', 'createRealWorldMapAdapter', 'leaflet_renderer_adapter_v1', 'maplibre_gl_v1', 'const mapRuntime', 'supports_future_engine_swap', 'gating_contract', 'renderRouteLine', 'renderTileFrame', 'renderEventPulse', 'onViewportChange', 'getCenter', 'getZoom', 'global_real_world_tiles', 'cn-shanghai-core', 'street_level_world_nodes', 'osm-z15', 'primary_actions', 'trillionnium-map-action', 'Move Here', '移动到这里', 'world-map-move-target', 'world-action-body', 'world-action-console-status', '起草世界行动', '起草任务后续', '推进下一条支线', '下一条支线', 'Event brief', '事件简报：', 'Linked task route', '关联任务路线', 'Recommended next step', '推荐下一步', 'Quest Route Graph', '任务路线图', 'world-route-task-graph-live', '/world/web/map-viewport', '/world/web/map-viewport', 'world-map-camera-summary', 'world-map-route-flow-status', 'world-map-route-next-step-status', 'world-map-route-link-status', 'world-work-deliver-id', 'world-work-deliver-body', 'world-buy-body', 'world-contract-completion-id', 'world-contract-completion-body', 'world-company-asset-id', 'world-listing-company-id', 'world-tile-shards-live', 'Character Items', '角色道具', 'Upgrade Item', '升级道具', 'Studios / Hubs', '工坊 / 据点', 'Launch Studio', '建立工坊', 'Hubs / Quest Cards', '据点 / 任务牌', 'Publish Quest Card', '发布任务牌', 'Bounties / Adventure Commissions', '悬赏 / 冒险委托', 'Accept Quest Card', '接取任务牌', 'Submit Result', '提交成果', 'Pass Rating', '评级通过', 'Faction Reputation Map', '阵营声望图', 'World Contracts', '世界契约', 'Complete Contract', '完成契约', 'findLiveEventByFocus', 'buildEventFocus', 'focusRouteEvent', 'filterLiveEventStream', '条事件镜头', 'data-focus-kind="event"', 'data-event-id=', 'data-task-id=', 'world-event-timeline-item-']:
...
summary = {
    ...
    'has_client_app_language_settings': all(token in app_html for token in ['TrillionniumLanguage', 'trillionnium.ui.language', 'data-trillionnium-language-select', 'trillionnium-system-language-settings', 'System Settings', '系统设置', 'English', '中文']),

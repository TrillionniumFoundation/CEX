...
summary = {
    ...
    'has_client_app_tactics_player_surface': all(token in app_html for token in ['app-tactics-player-hud', 'trillionnium_tactics_player_visible_surface_v1', 'app-tactics-objective-card', 'app-tactics-current-session-card', 'app-tactics-reward-history-handoff', 'app-tactics-repeat-farming-copy', 'data-reward-history-contract="trillionnium_tactics_reward_history_v1"', 'data-anti-cheese-contract="trillionnium_tactics_repeat_farming_anti_cheese_v1"', 'Repeat-farming guard']),
    ...
    'has_world_tactics_player_surface': all(token in world_html_after for token in ['world-tactics-player-hud', 'trillionnium_tactics_player_visible_surface_v1', 'world-tactics-objective-card', 'world-tactics-current-session-card', 'world-tactics-reward-history-handoff', 'world-tactics-repeat-farming-copy', 'data-reward-history-contract="trillionnium_tactics_reward_history_v1"', 'data-anti-cheese-contract="trillionnium_tactics_repeat_farming_anti_cheese_v1"', 'Repeat-farming guard']),

...
summary = {
    ...
    'has_client_app_map_readability_lod': all(token in app_html for token in ['trillionnium_world_map_readability_lod_v1', 'trillionnium_world_map_game_layer_semantics_v1', 'map_readability_lod_visible', 'map_game_layer_semantics_visible', 'app-map-readability-lod', 'data-visible-marker-budget="18"', 'One route first']),

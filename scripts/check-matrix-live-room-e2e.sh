...
world_map_result = send_and_wait('/map', 'trillionnium_world_map', lambda content, card: int(card.get('node_count') or 0) >= 8 and bool(card.get('current_node_id')) and card.get('has_real_world_map_engine') is True and card.get('map_engine_id') == 'leaflet_openstreetmap_v1' and card.get('tile_provider') == 'OpenStreetMap' and card.get('mirror_scope') == 'global_real_world_tiles' and map_renderer_adapter_ok(card) and bool(card.get('active_region_id')) and ('route_preview_item_count' in card) and ('route_task_graph_count' in card) and route_story_ok(card, command_prefix='/world action') and route_opportunity_target_ok(card, expected_action_label='Open world action lane') and route_runner_handoff_ok(card) and card.get('has_trillionnium_combat_log') is True and card.get('trillionnium_combat_log_contract') == 'trillionnium_combat_log_v1' and int(card.get('trillionnium_combat_log_beat_count') or 0) >= 1 and card.get('trillionnium_osm_objective_contract') == 'trillionnium_osm_objective_v1' and int(card.get('trillionnium_osm_objective_count') or 0) >= 1 and card.get('trillionnium_npc_relationship_contract') == 'trillionnium_npc_relationship_v1' and card.get('tactics_combat_resolution_contract') == 'trillionnium_tactics_combat_resolution_v1' and card.get('tactics_game_session_contract') == 'trillionnium_tactics_game_session_v1' and card.get('tactics_simulation_tick_contract') == 'trillionnium_tactics_simulation_tick_v1' and card.get('tactics_reward_settlement_contract') == 'trillionnium_tactics_reward_settlement_v1' and 'tactics_objective_progress' in card and 'tactics_victory_state' in card and 'tactics_reward_status' in card and card.get('map_overlay_identity_contract') == 'trillionnium_map_overlay_identity_v1' and int(card.get('map_overlay_identity_count') or 0) >= 1 and 'Trillionnium战报' in str(content.get('body') or ''))
...
print(json.dumps({
    ...
    'world_map_trillionnium_combat_log_contract': world_map_result['reply']['card'].get('trillionnium_combat_log_contract'),
    'world_map_trillionnium_combat_log_beat_count': world_map_result['reply']['card'].get('trillionnium_combat_log_beat_count'),
    'world_map_trillionnium_osm_objective_contract': world_map_result['reply']['card'].get('trillionnium_osm_objective_contract'),
    'world_map_trillionnium_osm_objective_count': world_map_result['reply']['card'].get('trillionnium_osm_objective_count'),
    'world_map_trillionnium_npc_relationship_contract': world_map_result['reply']['card'].get('trillionnium_npc_relationship_contract'),
    'world_map_tactics_combat_resolution_contract': world_map_result['reply']['card'].get('tactics_combat_resolution_contract'),
    'world_map_tactics_game_session_contract': world_map_result['reply']['card'].get('tactics_game_session_contract'),
    'world_map_tactics_session_id': world_map_result['reply']['card'].get('tactics_session_id'),
    'world_map_tactics_simulation_tick_contract': world_map_result['reply']['card'].get('tactics_simulation_tick_contract'),
    'world_map_tactics_simulation_tick_count': world_map_result['reply']['card'].get('tactics_simulation_tick_count'),
    'world_map_tactics_reward_settlement_contract': world_map_result['reply']['card'].get('tactics_reward_settlement_contract'),
    'world_map_tactics_objective_progress': world_map_result['reply']['card'].get('tactics_objective_progress'),
    'world_map_tactics_victory_state': world_map_result['reply']['card'].get('tactics_victory_state'),
    'world_map_tactics_reward_status': world_map_result['reply']['card'].get('tactics_reward_status'),
    'world_map_overlay_identity_contract': world_map_result['reply']['card'].get('map_overlay_identity_contract'),
    'world_map_overlay_identity_count': world_map_result['reply']['card'].get('map_overlay_identity_count'),
    'world_map_route_preview_item_count': world_map_result['reply']['card'].get('route_preview_item_count'),
    'world_map_route_task_graph_count': world_map_result['reply']['card'].get('route_task_graph_count'),
    'world_map_route_next_task_id': world_map_result['reply']['card'].get('route_next_task_id'),
    'world_map_route_next_action_label': world_map_result['reply']['card'].get('route_next_action_label'),

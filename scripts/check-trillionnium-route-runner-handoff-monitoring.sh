...
expected_alerts = {
    ...
    'CexTrillionniumWorldMapReadabilityLodNotGreen': {
        'metric': 'cex_consumer_entry_trillionnium_world_map_readability_lod_gate_green',
        'expr_fragments': ['== 0'],
        'for': '5m',
        'severity': 'critical',
        'route_hint': 'page',
    ...
    'CexTrillionniumWorldMapDensityScalabilityNotGreen': {
        'metric': 'cex_consumer_entry_trillionnium_world_map_density_scalability_gate_green',
        'expr_fragments': ['== 0'],
        'for': '5m',
        'severity': 'critical',
        'route_hint': 'page',
    },
    'CexTrillionniumWorldMapOfflineActionQueueNotGreen': {
        'metric': 'cex_consumer_entry_trillionnium_world_map_offline_action_queue_gate_green',
        'expr_fragments': ['== 0'],
        'for': '10m',
        'severity': 'warning',
        'route_hint': 'page',
    ...
    'CexTrillionniumWorldMapRumMatrixCoverageMissing': {
        'metric': 'cex_consumer_entry_trillionnium_world_map_rum_sample_matrix_gate_green',
        'extra_metrics': ['cex_consumer_entry_trillionnium_world_map_rum_sample_matrix_missing_bucket_count'],
        'expr_fragments': ['== 0', ' or ', '> 0'],
        'for': '15m',
        'severity': 'warning',
        'route_hint': 'product',
    },
    ...
    'CexTrillionniumRouteRunnerRewardToNextRouteWeak': {
        'metric': 'cex_consumer_entry_trillionnium_route_runner_funnel_reward_to_next_route_percent',
        'expr_fragments': ['< 5'],
        'for': '30m',
        'severity': 'warning',
        'route_hint': 'product',
    },
    'CexTrillionniumWorldCommercialDashboardNotGreen': {
        'metric': 'cex_consumer_entry_trillionnium_world_commercial_operating_dashboard_gate_green',
        'expr_fragments': ['== 0'],
        'for': '10m',
        'severity': 'warning',
        'route_hint': 'product',
    },
    'CexTrillionniumWorldRouteRecommendationQualityNotGreen': {
        'metric': 'cex_consumer_entry_trillionnium_world_route_recommendation_quality_gate_green',
        'expr_fragments': ['== 0'],
        'for': '10m',
        'severity': 'warning',
        'route_hint': 'product',
    },
    'CexTrillionniumWorldRouteRecommendationQualityBelowTarget': {
        'metric': 'cex_consumer_entry_trillionnium_world_route_recommendation_quality_score_percent',
        'extra_metrics': ['cex_consumer_entry_trillionnium_world_route_recommendation_quality_score_target_percent'],
        'expr_fragments': ['<', 'cex_consumer_entry_trillionnium_world_route_recommendation_quality_score_target_percent'],
        'for': '30m',
        'severity': 'warning',
        'route_hint': 'product',
    },
    'CexTrillionniumWorldFutureEngineReadinessNotGreen': {
        'metric': 'cex_consumer_entry_trillionnium_world_future_engine_readiness_gate_green',
        'expr_fragments': ['== 0'],
        'for': '10m',
        'severity': 'warning',
        'route_hint': 'chat',
    },
    'CexTrillionniumWorldMapMapLibreShadowParityNotGreen': {
        'metric': 'cex_consumer_entry_trillionnium_world_map_maplibre_shadow_parity_gate_green',
        'extra_metrics': ['cex_consumer_entry_trillionnium_world_map_maplibre_canary_rollback_ready'],
        'expr_fragments': ['== 0', ' or '],
        'for': '10m',
        'severity': 'warning',
        'route_hint': 'chat',
    },
    'CexTrillionniumWorldMapGameplayAccessibilityI18nNotGreen': {
        'metric': 'cex_consumer_entry_trillionnium_world_map_gameplay_accessibility_i18n_gate_green',
        'expr_fragments': ['== 0'],
        'for': '10m',
        'severity': 'warning',
        'route_hint': 'product',
...
expected_dashboard = {
    ...
    'panels': {
        ...
        'Retention cohort / commercial operating dashboard': {
            'type': 'timeseries',
            'metrics': [
                'cex_consumer_entry_trillionnium_route_runner_funnel_reward_to_next_route_percent',
                'cex_consumer_entry_trillionnium_route_runner_funnel_d1_resume_percent',

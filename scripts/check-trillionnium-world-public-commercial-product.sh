...
PROVIDER_PROBE_MODEL="${CEX_PUBLIC_COMMERCIAL_PROVIDER_PROBE_MODEL:-${CEX_PROVIDER_PROBE_MODEL:-google/gemini-2.5-flash}}"
PROVIDER_PROBE_TRANSPORT="${CEX_PUBLIC_COMMERCIAL_PROVIDER_PROBE_TRANSPORT:-${CEX_PROVIDER_PROBE_TRANSPORT:-local}}"
PROVIDER_PROBE_TIMEOUT_SECONDS="${CEX_PUBLIC_COMMERCIAL_PROVIDER_PROBE_TIMEOUT_SECONDS:-${CEX_PROVIDER_PROBE_TIMEOUT_SECONDS:-180}}"

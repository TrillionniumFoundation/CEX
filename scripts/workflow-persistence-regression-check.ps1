# COMPATIBILITY SHIM
# Original script moved to scripts\\legacy\\workflow-persistence-regression-check.ps1.
...
$legacyPath = Join-Path $PSScriptRoot 'legacy\\workflow-persistence-regression-check.ps1'
& $legacyPath @args
exit $LASTEXITCODE

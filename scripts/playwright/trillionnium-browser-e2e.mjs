...
async function main() {
  ...
  assert(await count(page, '#world-live-events-live[data-render-owner="rust_world_ui_renderer"][data-rust-live-task-ui-contract="trillionnium_world_rust_live_task_ui_fragments_v1"][data-browser-ui-owner="input_only_focus_bridge"]') === 1, 'world live-event cards missing Rust-owned live/task UI fragment contract');
  assert(await count(page, '#world-avatar-task-routes-live[data-render-owner="rust_world_ui_renderer"][data-rust-live-task-ui-contract="trillionnium_world_rust_live_task_ui_fragments_v1"][data-browser-ui-owner="input_only_focus_bridge"]') === 1, 'world avatar-task-route cards missing Rust-owned live/task UI fragment contract');
  assert(await page.evaluate(() => document.querySelector('#trillionnium-world-map-data')?.textContent?.includes('rust_owned_live_task_ui_fragments')), 'world map bootstrap missing Rust-owned live/task UI fragments');
  assert(await page.evaluate(() => document.documentElement.outerHTML.includes('server_rendered_live_event_and_task_route_cards_selected_by_focus_bridge')), 'world shell missing live/task focus-bridge hydration policy');
  assert(await count(page, '#world-real-map[data-rust-map-popup-ui-contract="trillionnium_world_rust_map_popup_ui_fragments_v1"][data-popup-render-owner="rust_world_ui_renderer"][data-popup-browser-role="input_only_click_bridge"]') === 1, 'world map missing Rust-owned popup UI fragment contract');
  assert(await page.evaluate(() => document.querySelector('#trillionnium-world-map-data')?.textContent?.includes('rust_owned_map_popup_ui_fragments')), 'world map bootstrap missing Rust-owned popup UI fragments');
  assert(await page.evaluate(() => document.querySelector('#trillionnium-world-map-data')?.textContent?.includes('server_rendered_map_popups_bound_by_browser_adapter')), 'world map bootstrap missing Rust-owned popup hydration policy');
  assert(await count(page, '#world-tile-shards-live[data-rust-map-support-ui-contract="trillionnium_world_rust_map_support_ui_fragments_v1"][data-render-owner="rust_world_ui_renderer"][data-browser-ui-owner="input_only_focus_bridge"]') === 1, 'world tile shards missing Rust-owned map support UI fragment contract');
  assert(await count(page, '#world-map-stream-hud[data-rust-map-support-ui-contract="trillionnium_world_rust_map_support_ui_fragments_v1"][data-render-owner="rust_world_ui_renderer"][data-browser-ui-owner="input_only_focus_bridge"]') === 1, 'world stream HUD missing Rust-owned map support UI fragment contract');
  assert(await page.evaluate(() => document.querySelector('#trillionnium-world-map-data')?.textContent?.includes('rust_owned_map_support_ui_fragments')), 'world map bootstrap missing Rust-owned support UI fragments');
  assert(await page.evaluate(() => document.querySelector('#trillionnium-world-map-data')?.textContent?.includes('server_rendered_map_support_cards_selected_by_viewport_bridge')), 'world map bootstrap missing Rust-owned support hydration policy');
  assert(await count(page, '#world-map-focus-summary[data-rust-map-focus-ui-contract="trillionnium_world_rust_map_focus_ui_fragments_v1"][data-render-owner="rust_world_ui_renderer"][data-browser-ui-owner="input_only_focus_bridge"]') === 1, 'world focus summary missing Rust-owned focus UI fragment contract');
  assert(await count(page, '#world-map-action-rail[data-rust-map-focus-ui-contract="trillionnium_world_rust_map_focus_ui_fragments_v1"][data-render-owner="rust_world_ui_renderer"][data-browser-ui-owner="input_only_focus_bridge"]') === 1, 'world map action rail missing Rust-owned focus UI fragment contract');
  assert(await page.evaluate(() => document.querySelector('#trillionnium-world-map-data')?.textContent?.includes('rust_owned_map_focus_ui_fragments')), 'world map bootstrap missing Rust-owned focus UI fragments');
  assert(await page.evaluate(() => document.querySelector('#trillionnium-world-map-data')?.textContent?.includes('server_rendered_map_focus_action_rail_selected_by_focus_bridge')), 'world map bootstrap missing Rust-owned focus hydration policy');

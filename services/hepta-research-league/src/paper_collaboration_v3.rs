...
pub(super) struct CollaborationMemory {
    ...
    artifact_manifests: HashMap<Uuid, ArtifactManifest>,
    ...
    proposals: HashMap<Uuid, AgentProposal>,
    decisions: HashMap<Uuid, HumanDecision>,
    section_revisions: HashMap<Uuid, SectionRevision>,
    section_reviews: HashMap<Uuid, SectionReview>,

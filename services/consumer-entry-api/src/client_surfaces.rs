...
fn client_app_route_runner_handoff_json(
    ...
    let runner_items: &[Value] = viewport
        ...
        .map(Vec::as_slice)
        .unwrap_or(&[]);
    world_map_route_runner_handoff_json(metrics.avatar_task_route_count, runner_items)
}
    ...
    fn mobile_shell_contract_json(&self) -> Value {
        json!({
            ...
            "runtime_performance_budget": {
                ...
                "density_scalability": trillionnium_world_map_density_scalability_json(6, 2, 18),
            },
            ...
            "resilience": {
                ...
                "online_refresh": true,
                "map_cached_snapshot_key": "trillionnium-world-map:last-good-viewport:v1",
                "map_delta_304_supported": true,
                "map_weak_network_contract_version": TRILLIONNIUM_WORLD_MAP_WEAK_NETWORK_CONTRACT_VERSION,
            ...
            "readiness_checks": [
                ...
                "map_rum_slo_quantiles_visible",
                "map_rum_real_user_matrix_visible",
                "map_weak_network_resilience_visible",
                "map_offline_action_queue_visible",
                "map_location_privacy_visible",
                "map_game_layer_semantics_visible",
                "map_gameplay_accessibility_i18n_visible",
                "map_density_scalability_visible",
                "next_action_rail_visible",
                "playability_coach_visible",
                "p0_next_best_action_visible",
                "p1_strategy_choices_visible",

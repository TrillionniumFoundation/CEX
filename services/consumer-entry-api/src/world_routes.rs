...
pub(super) async fn get_world_map_viewport(
    ...
    let map_focus_fragments = world_rust_map_focus_ui_fragments_json(&viewport);
...
async fn world_map_delta_response(
    ...
    let map_focus_fragments = world_rust_map_focus_ui_fragments_json(&current_viewport);

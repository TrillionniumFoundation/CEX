...
pub(super) fn term_exchange_kernel_manifest_json(state: &AppState) -> Value {
    json!({
        ...
        "state_persistence": {
            ...
            "normalized_receipt_read_model_probe_status": "receipt_projection_objects_exposed_in_world_home_and_client_feed",
            "runtime_receipt_projection_status": "typed_receipts_projected_and_sql_read_model_hydrated_for_read_and_command_home_surfaces"
        },

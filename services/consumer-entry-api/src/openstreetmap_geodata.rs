...
const OPENSTREETMAP_SEMANTIC_ROLE_MAPPINGS: &[OpenStreetMapSemanticRoleMapping] = &[
    ...
    OpenStreetMapSemanticRoleMapping {
        ...
        source_layer: "buildings",
        game_system_role: "witness_archive_anchor",
        objective_kind: "witness_case_reconstruction",
        completion_owner: "rust_trillionnium_task_completion_handler",
    },
    OpenStreetMapSemanticRoleMapping {
        semantic_role: "patrol_yard",
        source_layer: "areas",
        game_system_role: "night_watch_patrol_anchor",
        objective_kind: "night_watch_message_route",
        completion_owner: "rust_world_graph_objective_travel",
    },
    OpenStreetMapSemanticRoleMapping {
        semantic_role: "water_supply",
        source_layer: "pois",
        game_system_role: "survival_water_anchor",
        objective_kind: "cistern_refill_run",
        completion_owner: "rust_trillionnium_resource_pressure_runtime_state",
    },
    OpenStreetMapSemanticRoleMapping {
        semantic_role: "ration_kitchen",
        source_layer: "buildings",
        game_system_role: "survival_food_anchor",
        objective_kind: "ration_supply_run",
        completion_owner: "rust_trillionnium_food_water_age_survival_state",
    },
    OpenStreetMapSemanticRoleMapping {
        semantic_role: "infirmary",
        source_layer: "buildings",
        game_system_role: "field_recovery_anchor",
        objective_kind: "injury_recovery_round",
        completion_owner: "rust_trillionnium_resource_pressure_runtime_state",
    },
    OpenStreetMapSemanticRoleMapping {
        semantic_role: "mediation_steps",
        source_layer: "pois",
        game_system_role: "elder_mediation_anchor",
        objective_kind: "relationship_mediation",
        completion_owner: "rust_world_relationships_dynamic_social_state",
    },
    OpenStreetMapSemanticRoleMapping {
        semantic_role: "mentor_cloister",
        source_layer: "areas",
        game_system_role: "long_term_training_anchor",
        objective_kind: "mentor_title_oath",
        completion_owner: "rust_mentor_training_validator",
    },
    OpenStreetMapSemanticRoleMapping {
        semantic_role: "courier_yard",
        source_layer: "roads",
        game_system_role: "route_handoff_anchor",
        objective_kind: "courier_handoff_chain",
        completion_owner: "rust_world_graph_objective_travel",
    },
    OpenStreetMapSemanticRoleMapping {
        semantic_role: "survey_tower",
        source_layer: "pois",
        game_system_role: "terrain_survey_anchor",
        objective_kind: "survey_tower_chart",
        completion_owner: "rust_world_graph_objective_travel",
    },
    OpenStreetMapSemanticRoleMapping {
        semantic_role: "guild_vault",
        source_layer: "buildings",
        game_system_role: "guild_evidence_vault_anchor",
        objective_kind: "guild_vault_audit",
        completion_owner: "rust_review_hold_gate",
    },
    OpenStreetMapSemanticRoleMapping {
        semantic_role: "auction_arcade",
        source_layer: "pois",
        game_system_role: "auction_appraisal_anchor",
        objective_kind: "auction_appraisal_route",
        completion_owner: "rust_inventory_crafting_gate",
    },
    OpenStreetMapSemanticRoleMapping {
        semantic_role: "caravan_camp",
        source_layer: "areas",
        game_system_role: "caravan_rest_anchor",
        objective_kind: "caravan_recovery_camp",
        completion_owner: "rust_trillionnium_food_water_age_survival_state",
    },
];
...
pub(super) fn openstreetmap_fixture_identity_for(
    ...
    match node.node_id.as_str() {
        ...
        "witness-archive" => OpenStreetMapFixtureIdentity {
            osm_type: "node",
            osm_id: 31_230_416_401,
            semantic_role: "archive",
            source_layer: "buildings",
        },
        "night-watch-yard" => OpenStreetMapFixtureIdentity {
            osm_type: "way",
            osm_id: 31_230_416_402,
            semantic_role: "patrol_yard",
            source_layer: "areas",
        },
        "river-cistern" => OpenStreetMapFixtureIdentity {
            osm_type: "node",
            osm_id: 31_230_416_403,
            semantic_role: "water_supply",
            source_layer: "pois",
        },
        "ration-kitchen" => OpenStreetMapFixtureIdentity {
            osm_type: "node",
            osm_id: 31_230_416_404,
            semantic_role: "ration_kitchen",
            source_layer: "buildings",
        },
        "field-infirmary" => OpenStreetMapFixtureIdentity {
            osm_type: "node",
            osm_id: 31_230_416_405,
            semantic_role: "infirmary",
            source_layer: "buildings",
        },
        "elder-step" => OpenStreetMapFixtureIdentity {
            osm_type: "way",
            osm_id: 31_230_416_406,
            semantic_role: "mediation_steps",
            source_layer: "pois",
        },
        "mentor-cloister" => OpenStreetMapFixtureIdentity {
            osm_type: "relation",
            osm_id: 31_230_416_407,
            semantic_role: "mentor_cloister",
            source_layer: "areas",
        },
        "courier-yard" => OpenStreetMapFixtureIdentity {
            osm_type: "way",
            osm_id: 31_230_416_408,
            semantic_role: "courier_yard",
            source_layer: "roads",
        },
        "survey-tower" => OpenStreetMapFixtureIdentity {
            osm_type: "node",
            osm_id: 31_230_416_409,
            semantic_role: "survey_tower",
            source_layer: "pois",
        },
        "guild-vault" => OpenStreetMapFixtureIdentity {
            osm_type: "node",
            osm_id: 31_230_416_410,
            semantic_role: "guild_vault",
            source_layer: "buildings",
        },
        "auction-arcade" => OpenStreetMapFixtureIdentity {
            osm_type: "way",
            osm_id: 31_230_416_411,
            semantic_role: "auction_arcade",
            source_layer: "pois",
        },
        "caravan-rest-camp" => OpenStreetMapFixtureIdentity {
            osm_type: "way",
            osm_id: 31_230_416_412,
            semantic_role: "caravan_camp",
            source_layer: "areas",
        },
...
fn openstreetmap_amenity_tag(node: &WorldMapNode) -> &'static str {
    ...
    match identity.semantic_role {
        ...
        "archive" => "archive",
        "patrol_yard" | "courier_yard" => "courier",
        "water_supply" => "drinking_water",
        "ration_kitchen" | "caravan_camp" => "shelter",
        "infirmary" => "clinic",
        "mediation_steps" | "mentor_cloister" => "community_centre",
        "survey_tower" => "viewpoint",
        "guild_vault" => "warehouse",
        "auction_arcade" => "marketplace",
        _ => "community_centre",
    }
}

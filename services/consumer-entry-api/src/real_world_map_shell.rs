    ...
    r#"      const createRealWorldMapAdapter = () => ({
      ...
      const mapText = (value) => {
        ...
        const replacements = [
          ...
          ['route_task', 'route task / 路线任务'], ['avatar_task_route', 'avatar task route / 角色任务路线'], ['avatar_route_runner', 'avatar route runner / 跑图角色'], ['Task routes', 'Task routes / 任务路线'], ['Avatar Task Routes', 'Avatar Task Routes / 角色任务路线'], ['Avatar Movement', 'Avatar Movement / 角色跑图'], ['Moving avatars', 'Moving avatars / 动态角色'], ['Trace route / 追踪路线', 'Trace route / 追踪路线'], ['Follow runner / 跟随角色', 'Follow runner / 跟随角色'], ['Complete checkpoint / 完成检查点', 'Complete checkpoint / 完成检查点'], ['Reward checkpoint / 奖励检查点', 'Reward checkpoint / 奖励检查点'], ['Ready to complete / 可完成', 'Ready to complete / 可完成'], ['Reward checkpoint locked / 奖励检查点未解锁', 'Reward checkpoint locked / 奖励检查点未解锁'], ['Approaching checkpoint / 接近检查点', 'Approaching checkpoint / 接近检查点'], ['Submit evidence → rating/reward / 提交证据 → 评级奖励', 'Submit evidence → rating/reward / 提交证据 → 评级奖励'], ['animated path / 动态路径', 'animated path / 动态路径'], ['looping_avatar_task_run', 'looping avatar task run / 循环任务跑图'], ['en_route_to_task_reward', 'en route to task reward / 正在跑向任务奖励'], ['ready_to_complete', 'ready to complete / 可完成'], ['contract_capture', 'contract capture / 契约登记'], ['work_order', 'quest commission / 冒险委托'], ['delivery', 'result submit / 成果提交'], ['acceptance', 'rating pass / 评级'], ['rejection', 'revision / 返工'], ['reopen', 'reopen / 重开'], ['cancellation', 'cancel / 放弃'], ['live_event', 'live event / 实时事件'],

...
pub(super) fn default_league_state() -> LeagueState {
    let matches = [
        ...
        LeagueMatch {
            ...
            status: "open".to_string(),
            objective: "像 Pokémon 近距离对战一样，面对面选择 Agent 阵容、出招、提交证据并结算。"
                .to_string(),
...
pub(super) fn default_world_map_nodes() -> HashMap<String, WorldMapNode> {
    [
        ...
        world_map_node(
            ...
            "Asset Yard",
            "asset_yard",
            "所有 World asset 的仓库和展示院，未来可拖拽摆放。",
            1,
            1,
...
impl LeagueStateRepositorySnapshot {
    ...
    pub(super) fn runtime_dual_write_sql_bytes(
        ...
        self.sql_snapshot_bytes_with_normalized_sql(&normalized_world_shadow_sql)
    }

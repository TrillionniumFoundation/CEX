...
grep -Fq 'let legacy_golden = authority.evaluator_manifest_hash' "$bridge"
grep -Fq '&authority.dataset_manifest_hash,' "$bridge"
grep -Fq 'if legacy_golden {' "$bridge"
grep -Fq '"text/markdown; charset=utf-8"' "$bridge"

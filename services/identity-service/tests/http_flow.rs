...
#[tokio::test]
async fn metrics_endpoint_exports_identity_runtime_gauges() {
    ...
    assert!(body.contains("cex_identity_service_up 1\n"));
    assert!(body.contains("cex_identity_static_api_keys_total 1\n"));
    assert!(body.contains("cex_identity_admin_tokens_total 1\n"));
    assert!(body.contains("cex_identity_postgres_configured 0\n"));
}

...
- Sequence-51 architecture closure: [`docs/architecture/external-agent-runtime-boundary-sequence-51.md`](docs/architecture/external-agent-runtime-boundary-sequence-51.md)
- Sequence-51 machine traceability: [`docs/traceability/sequence-51-architecture-v1.json`](docs/traceability/sequence-51-architecture-v1.json)
